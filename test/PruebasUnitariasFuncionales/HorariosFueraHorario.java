...
public class HorariosFueraHorario {
    ...
    @Test
    public void testHorariosFueraHorario() {
        try {
            String testFilePath = "test\\resources\\med_input_FueraHorario.txt";
            ...
            assertTrue("Debe contener mensaje de error", 
                       output.contains("La cita está fuera del horario de atención"));
