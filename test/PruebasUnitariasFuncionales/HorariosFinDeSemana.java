...
public class HorariosFinDeSemana {
    ...
    @Test
    public void testHorariosFinDeSemana() {
        try {
            String testFilePath = "test\\resources\\med_input_FinDeSemana.txt";
            ...
            assertTrue("Debe contener mensaje de error", 
                       output.contains("No se puede agendar citas en fines de semana"));
